import {
  to = segment_destination_subscription.id-6a3590aca2ebd389a77447cc_6vjhrG6AaVaS1EsSuq71mD
  id = "6a3590aca2ebd389a77447cc:6vjhrG6AaVaS1EsSuq71mD"
}

resource "segment_destination_subscription" "id-6a3590aca2ebd389a77447cc_6vjhrG6AaVaS1EsSuq71mD" {
  action_id            = "pAMZTGDc7yKTW5ZGecP8Df"
  destination_id       = "6a3590aca2ebd389a77447cc"
  enabled              = true
  model_id             = null
