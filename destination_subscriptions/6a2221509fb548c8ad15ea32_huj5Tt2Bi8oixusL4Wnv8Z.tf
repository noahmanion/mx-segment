import {
  to = segment_destination_subscription.id-6a2221509fb548c8ad15ea32_huj5Tt2Bi8oixusL4Wnv8Z
  id = "6a2221509fb548c8ad15ea32:huj5Tt2Bi8oixusL4Wnv8Z"
}

resource "segment_destination_subscription" "id-6a2221509fb548c8ad15ea32_huj5Tt2Bi8oixusL4Wnv8Z" {
  ...
  settings = jsonencode({
    ...
    custom_data = {
      utm_content = {
        "@template" = "utm {{properties.utm_content}}"
      }
      utm_term = {
        "@path" = "$.properties.utm_term"
      }
    }
    event_id = {
      "@path" = "$.anonymousId"
    }
    event_name = "MXB_SignupFormStarted"
    event_source_url = {
  ...
  trigger = "event = \"Signup Form Started\""
}