import {
  to = segment_destination.id-69fc9dc7ec185405bf0315f8
  id = "69fc9dc7ec185405bf0315f8"
}

resource "segment_destination" "id-69fc9dc7ec185405bf0315f8" {
  enabled = false
  metadata = {
    contacts          = null
  ...
  name = "Pipedrive Destination Function - Backend"
  settings = jsonencode({
    ...
    pdDealDaysInTrial                = "892dd0c72de9fc0a8410ac5ad71156a5c7a65fe2"
    pdDealEngagementScore            = "d4dfa00f8274b1eed74b1d1ec894046a304f22d5"
    ...
    pipedriveDomain                  = "api.pipedrive.com"
    ...
    pipedriveFieldUtmMedium          = "a253952508b97483aff69944286a2a1e3d49ef17"
    pipedriveFieldUtmSource          = "21d79aa6147112079d6b488e24855e4452196d02"
    pipedriveOnboardingScheduled     = "55"
    pipedriveOrgFieldMrr             = "ebbd4d869e9e65d35aec47aa3b313e739ff133da"
    ...
    pipedriveStageTrialEnding        = "43"
    pipedriveStageTrialExpired       = "54"
    pipedriveStageTrialSignup        = "41"
  })
